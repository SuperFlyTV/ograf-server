					...
					<Stack direction="row" spacing={1} justifyContent="flex-start">
						<Tooltip title="F3">
							<Button
								...
								variant="outlined"
								onClick={(e) => {
									handleAction('load', e).catch(console.error)
								}}
							>
								Load
							</Button>
						...
						<Tooltip title="F2">
							<Button
								...
								color="primary"
								onClick={(e) => {
									handleAction('play', e).catch(console.error)
								}}
							>
								Play
							</Button>
						...
						<Tooltip title="F6">
							<Button
								...
								color="secondary"
								onClick={(e) => {
									handleAction('update', e).catch(console.error)
								}}
							>
								Update
							</Button>
						...
						<Tooltip title="F1">
							<Button
								...
								color="error"
								onClick={(e) => {
									handleAction('stop', e).catch(console.error)
								}}
							>
								Stop
							</Button>
