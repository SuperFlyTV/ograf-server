			...
			<Stack spacing={3}>
				<Card>
					<CardContent>
						...
						{serverSettings.data?.namespaceEnabled ? <NamespaceSection /> : <NoNamespaceSection />}
...
const NoNamespaceSection: React.FC = () => {
	// This content is displayed when the server is not running in namespace mode, ie when hosted locally.
	return (
		<>
			<Typography variant="body1">This is a web server that provides:</Typography>
