...
import { ServerApi, GraphicsAPI, ActionInvokeParams, EmptyPayload, VendorSpecific, GraphicsManifest } from 'ograf'
 ...
 */
export type GraphicInvokeActionTarget = ServerApi.components['schemas']['GraphicTarget']
...
export interface Endpoints {
	...
	invokeGraphicUpdateAction: {
		...
		returnValue: Awaited<ReturnType<GraphicsAPI.Graphic['updateAction']>> | ErrorReturnValue
	}
	/**
	...
	invokeGraphicPlayAction: {
		...
		returnValue: Awaited<ReturnType<GraphicsAPI.Graphic['playAction']>> | ErrorReturnValue
	}
	/**
	...
	invokeGraphicStopAction: {
		...
		returnValue: Awaited<ReturnType<GraphicsAPI.Graphic['stopAction']>> | ErrorReturnValue
	}
	/**
	...
	invokeGraphicCustomAction: {
		...
		returnValue: Awaited<ReturnType<GraphicsAPI.Graphic['customAction']>> | ErrorReturnValue
	}
}
