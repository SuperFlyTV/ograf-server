...
export interface components {
  schemas: {
     ...
     */
    RenderTargetSchema:
      | components["schemas"]["ShallowGDDObjectSchema"]
      | ({
    ...
    validation:
      | ({
          type?:
            | components["schemas"]["simpleTypes"]
            | components["schemas"]["simpleTypes"][];
          const?: unknown;
          enum?: unknown[];
          multipleOf?: number;
    ...
    schema: (
      | (({
          ...
          (components["schemas"]["core"] &
            components["schemas"]["applicator"] &
            components["schemas"]["unevaluated"] &
            components["schemas"]["validation"] &
            components["schemas"]["meta-data"] &
      ...
      | (boolean &
          (components["schemas"]["core"] &
            ...
            components["schemas"]["validation"] &
            components["schemas"]["meta-data"] &
            components["schemas"]["format-annotation"] &
            components["schemas"]["content"]))
    ) &
      (components["schemas"]["core"] &
        components["schemas"]["applicator"] &
    ...
    object: ({
      ...
      (components["schemas"]["schema"] &
        components["schemas"]["gdd-types"] &
        components["schemas"]["basic-types"]);
    action: {
